# PadiPay WhatsApp Bot

Welcome to the **PadiPay WhatsApp Bot** directory! 
...
This directory contains the Node.js/Express application that serves as the **WhatsApp Bot**.
...
> **Note:** This service acts as the communication layer and state machine for the chat interface. Core business logic and blockchain interactions are handled by the PadiPay Relayer API.
