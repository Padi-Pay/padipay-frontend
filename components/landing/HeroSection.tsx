...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden pt-24 pb-32 md:pt-28 bg-surface min-h-[100dvh]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          Trade with confidence, even with people you&apos;ve <span className="text-primary italic">never met.</span>
        </motion.h1>
        ...
        >
          PadiPay uses WhatsApp, escrow protection, and trusted community mediators to make everyday trade safer and simpler across the global ecosystem.
        </motion.p>
