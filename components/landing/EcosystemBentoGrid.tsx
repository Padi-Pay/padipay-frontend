...
import { Network, Webhook, FileCode2, Users, Castle, Archive, Star, GitFork, ExternalLink } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div className="max-w-2xl">
            ...
            >
              Modular architecture designed for developers to build the next generation of trusted commerce tools.
            </motion.p>
          </div>
          <motion.button 
            ...
            viewport={{ once: true }}
            className="text-primary font-semibold flex items-center gap-2 hover:underline decoration-2 underline-offset-4"
          >
        ...
        >
          {repos.map((repo, index) => (
            <motion.div
              ...
              className="relative bg-white p-8 rounded-3xl border border-outline-variant shadow-sm hover:shadow-md transition-all group overflow-hidden"
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <p className="text-sm text-foreground/70 mb-8 flex-grow leading-relaxed">
                  {repo.description}
                </p>
